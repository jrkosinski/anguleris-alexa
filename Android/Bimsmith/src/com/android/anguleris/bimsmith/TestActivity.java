...
public class TestActivity extends Activity {
    ...
    static final String LOG_TAG = TestActivity.class.getCanonicalName();

    // --- Constants to modify per your configuration ---

    // Customer specific IoT endpoint
    // AWS Iot CLI describe-endpoint call returns: XXXXXXXXXX.iot.<region>.amazonaws.com,
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a21jd7gud1swyd.iot.us-east-1.amazonaws.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSubscribe.setText("$aws/things/bimsmith-thing/shadow/update/accepted");
